...
export default function BlueprintDetail({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col">
      ...
      <main className="flex-1 max-w-6xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 flex flex-col gap-5 sm:gap-6">

        {/* Header Back & Action Buttons */}
        <div className="flex flex-col gap-3 sm:gap-4 border-b border-slate-900 pb-4 sm:pb-5">
          <div className="flex items-start sm:items-center gap-2.5 sm:gap-3">
            <button
              onClick={() => router.push('/dashboard')}
              className="flex items-center justify-center p-2.5 rounded-lg text-slate-400 hover:bg-slate-900 hover:text-white transition-colors shrink-0 min-h-[44px] min-w-[44px]"
            >
            ...
            <div className="min-w-0 flex-1">
              ...
              <h2 className="text-sm sm:text-base lg:text-lg font-bold text-white line-clamp-1 mt-1">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button
              onClick={handleShare}
              className={`flex items-center gap-1.5 rounded-lg px-3 py-2.5 text-xs font-semibold border transition-all min-h-[40px] ${
                copiedLink
            ...
            <button
              ...
              disabled={exporting}
              className="flex items-center gap-1.5 rounded-lg border border-slate-800 bg-slate-900/40 px-3 py-2.5 text-xs font-semibold text-slate-300 hover:bg-slate-800 transition-colors min-h-[40px]"
            >
              {exporting ? (
            ...
            <button
              ...
              className="flex items-center justify-center rounded-lg p-2.5 text-slate-400 hover:bg-slate-900 hover:text-red-400 border border-slate-900/40 transition-colors min-h-[40px] min-w-[40px]"
        ...
        {/* Tab Contents panel */}
        <div className="rounded-2xl border border-slate-900 bg-slate-900/20 p-3 sm:p-4 md:p-6 glass min-h-[300px] sm:min-h-[350px]">
            ...
            <div className="space-y-5 sm:space-y-6">
              <div className="grid grid-cols-1 gap-3 sm:gap-4 sm:grid-cols-3">
                ...
                <div className="rounded-xl border border-slate-800 bg-slate-950/40 p-3 sm:p-4">
                  ...
                  <div className="text-lg sm:text-xl font-extrabold text-slate-200 mt-1">
                ...
                <div className="rounded-xl border border-slate-800 bg-slate-950/40 p-3 sm:p-4">
                  ...
                  <div className="text-lg sm:text-xl font-extrabold text-cyan-400 mt-1">
              ...
              <div className="grid grid-cols-1 gap-5 sm:gap-6 pt-4 border-t border-slate-900/60 md:grid-cols-2">
                <div className="space-y-3 sm:space-y-4">
                  <h3 className="text-xs sm:text-sm font-bold text-white uppercase tracking-wider">Market Dynamics</h3>
                  <div className="space-y-2.5">
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center bg-slate-950/20 border border-slate-900 p-3 rounded-lg text-xs gap-1 sm:gap-2">
                ...
                <div className="space-y-2">
                  <h3 className="text-xs sm:text-sm font-bold text-white uppercase tracking-wider">Executive Overview Summary</h3>
                  <p className="text-[10px] sm:text-xs text-slate-400 leading-relaxed bg-slate-950/20 p-3 sm:p-4 rounded-xl border border-slate-900">
          ...
          {activeTab === 'competitors' && (
            <div className="space-y-5 sm:space-y-6">
              <h3 className="text-xs sm:text-sm font-bold text-white uppercase tracking-wider">Top 5 Competitors & Positioning Map</h3>
              <div className="grid grid-cols-1 gap-3 sm:gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
                {data.competitors?.map((comp: any, index: number) => (
                  <div key={index} className="rounded-xl border border-slate-850 bg-slate-950/30 p-3 sm:p-4 flex flex-col justify-between">
                    <div>
                      <div className="flex justify-between items-center mb-2 gap-2">
                        <h4 className="text-xs font-bold text-white truncate">{comp.name}</h4>
                        <span className="text-[9px] font-semibold text-cyan-400 shrink-0">{comp.market_share_pct || 0}% share</span>
                      </div>
                      <p className="text-[10px] text-slate-400 leading-tight border-b border-slate-900 pb-2 mb-3">
                        {comp.positioning}
                      </p>

                      <div className="space-y-2.5 sm:space-y-3 text-[9px]">
                        <div>
                          ...
                          <ul className="space-y-0.5 text-slate-300 pl-2 list-disc">
                            {comp.strengths?.slice(0, 3).map((str: string) => (
                              <li key={str} className="leading-relaxed">{str}</li>
                            ))}
                          </ul>
                        </div>
                        <div>
                          ...
                          <ul className="space-y-0.5 text-slate-300 pl-2 list-disc">
                            {comp.weaknesses?.slice(0, 3).map((wk: string) => (
                              <li key={wk} className="leading-relaxed">{wk}</li>
                            ))}
                          </ul>
                        </div>
                      </div>
          ...
          {activeTab === 'personas' && (
            <div className="space-y-5 sm:space-y-6">
              <h3 className="text-xs sm:text-sm font-bold text-white uppercase tracking-wider">Target Buyer Personas</h3>
              <div className="grid grid-cols-1 gap-4 sm:gap-5 md:grid-cols-3">
                {data.customer_personas?.map((p: any, index: number) => (
                  <div key={index} className="rounded-xl border border-slate-800 bg-slate-950/30 p-4 sm:p-5 flex flex-col justify-between">
                    <div>
                      <div className="flex justify-between items-start border-b border-slate-900 pb-3 mb-3 sm:mb-4 gap-2">
                        <div className="min-w-0">
                          <h4 className="text-xs sm:text-sm font-bold text-white">{p.name}</h4>
                          <span className="text-[10px] text-slate-400">{p.role}</span>
                        </div>
                        <span className="text-[9px] font-semibold text-cyan-400 bg-cyan-950/20 px-2 py-0.5 rounded border border-cyan-500/10 shrink-0">
                          {p.willingness_to_pay} WTP
                        </span>
                      </div>

                      <p className="text-[10px] text-slate-400 leading-normal mb-3 sm:mb-4 font-mono italic">
                        {p.demographics}
                      </p>
                      ...
                      {p.contact_info && (
                        <div className="mt-3 sm:mt-4 pt-3 border-t border-slate-900">
                    ...
                    <div className="mt-4 sm:mt-6 pt-3 border-t border-slate-900 flex justify-between items-center text-[9px] text-slate-400">
          ...
          {activeTab === 'gtm' && (
            <div className="grid grid-cols-1 gap-6 sm:gap-8 md:grid-cols-2">
              <div className="space-y-3 sm:space-y-4">
                <h3 className="text-xs sm:text-sm font-bold text-white uppercase tracking-wider">Acquisition Channels</h3>
                <div className="space-y-2.5">
                  {data.go_to_market?.channels?.map((chan: any, index: number) => (
                    <div key={index} className="rounded-xl border border-slate-900 bg-slate-950/20 p-3 sm:p-4 flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2 sm:gap-3">
                      <div className="min-w-0">
                      ...
                      <span className="text-[9px] font-semibold text-cyan-400 bg-slate-950 border border-slate-800 px-2 py-0.5 rounded whitespace-nowrap shrink-0 self-start">
                        CAC: {chan.cac}
                      </span>
                    </div>
                  ))}
              ...
              <div className="space-y-3 sm:space-y-4">
                <h3 className="text-xs sm:text-sm font-bold text-white uppercase tracking-wider">12-Month Launch Roadmap</h3>
                <div className="relative border-l border-slate-800 pl-4 space-y-5 sm:space-y-6 ml-2 py-2">
                    ...
                    <div key={index} className="relative">
                      ...
                      <ul className="mt-1.5 space-y-1 pl-4 list-disc text-[10px] text-slate-300 leading-normal">
                        {road.milestones?.map((mil: string) => (
                          <li key={mil} className="leading-relaxed">{mil}</li>
                        ))}
                      </ul>
                    </div>
                  ))}
            ...
            <div className="space-y-5 sm:space-y-6">
              <div className="grid grid-cols-1 gap-3 sm:gap-4 md:grid-cols-3">
                {data.revenue_model?.tiers?.map((tier: any, index: number) => (
                  <div key={index} className="rounded-xl border border-slate-800 bg-slate-950/20 p-3 sm:p-4">
                    <h4 className="text-xs font-bold text-white">{tier.name}</h4>
                    <span className="text-base sm:text-lg font-bold text-cyan-400 block mt-1">{tier.price}</span>
                    <ul className="mt-3 space-y-1.5 pl-2 border-t border-slate-900 pt-3 text-[10px] text-slate-400 list-disc leading-normal">
                      {tier.features?.map((ft: string) => (
                        <li key={ft} className="leading-relaxed">{ft}</li>
                      ))}
                    </ul>
                  </div>
                ))}
              ...
              <div className="grid grid-cols-1 gap-5 sm:gap-6 pt-4 border-t border-slate-900/60 md:grid-cols-2">
                <div className="space-y-2 sm:space-y-3">
                  <h3 className="text-xs sm:text-sm font-bold text-white uppercase tracking-wider">3-Year Projections</h3>
                  <div className="table-responsive -mx-1 px-1">
                    <table className="w-full text-left text-[10px] sm:text-xs border border-slate-900 rounded-lg overflow-hidden min-w-[320px] sm:min-w-[400px]">
                    <thead className="bg-slate-950 text-slate-400 text-[10px] uppercase font-bold tracking-wider">
                      <tr>
                        ...
                        <th className="p-2.5 sm:p-3">Revenue Projection</th>
                        <th className="p-2.5 sm:p-3">Gross Margin</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-slate-900 text-slate-300">
                      {data.revenue_model?.annual_projections?.map((proj: any, index: number) => (
                        <tr key={index} className="hover:bg-slate-900/20">
                          <td className="p-2.5 sm:p-3 font-semibold">{proj.year}</td>
                          <td className="p-2.5 sm:p-3 text-cyan-400 font-bold">{proj.revenue}</td>
                          <td className="p-2.5 sm:p-3 text-emerald-400">{proj.margins}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
                ...
                <div className="space-y-2">
                  <h3 className="text-xs sm:text-sm font-bold text-white uppercase tracking-wider">Break-Even Analysis</h3>
                  <div className="rounded-xl border border-slate-900 bg-slate-950/20 p-3 sm:p-4 text-[10px] sm:text-xs text-slate-400 leading-relaxed flex items-start gap-2.5">
          ...
          {activeTab === 'mvp' && (
            <div className="space-y-5 sm:space-y-6">
              <h3 className="text-xs sm:text-sm font-bold text-white uppercase tracking-wider">MVP Target Feature Roadmap</h3>
              <div className="grid grid-cols-1 gap-2.5 sm:gap-3">
                {data.mvp_features?.map((feat: any, index: number) => (
                  <div key={index} className="rounded-xl border border-slate-900 bg-slate-950/20 p-3 sm:p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
                    <div className="min-w-0">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 text-[10px] font-semibold shrink-0 flex-wrap">
                      <span className={`px-2 sm:px-2.5 py-1 rounded-full ${
                      ...
                      <span className="bg-slate-950 border border-slate-850 px-2 sm:px-2.5 py-1 rounded-full text-slate-300">
                        {feat.effort}
                      </span>
                    </div>
                  </div>
          ...
          {activeTab === 'pitch' && (
            <div className="space-y-5 sm:space-y-6">
              <h3 className="text-xs sm:text-sm font-bold text-white uppercase tracking-wider">10-Slide Outline Structure</h3>
              <div className="grid grid-cols-1 gap-3 sm:gap-4 md:grid-cols-2">
                {data.pitch_deck_outline?.map((slide: any, index: number) => (
                  <div key={index} className="rounded-xl border border-slate-900 bg-slate-950/20 p-3 sm:p-4 flex gap-3 sm:gap-4">
                    <div className="h-7 w-7 sm:h-8 sm:w-8 rounded-lg gradient-bg flex items-center justify-center font-bold text-[10px] sm:text-xs text-white shrink-0 shadow-md">
                      {slide.slide_no}
                    </div>
                    <div className="min-w-0">
                      <h4 className="text-xs sm:text-sm font-bold text-white">{slide.title}</h4>
                      <p className="text-[9px] text-slate-500 mt-0.5 leading-snug">Visual recommendation: {slide.visual_recommendation}</p>
                      <ul className="mt-2 sm:mt-2.5 pl-4 list-disc space-y-1 text-[10px] text-slate-400 leading-relaxed">
          ...
          {activeTab === 'copy' && (
            <div className="space-y-5 sm:space-y-6">
              <div className="grid grid-cols-1 gap-4 sm:gap-6 md:grid-cols-2">
                <div className="space-y-3 sm:space-y-4">
                  <h3 className="text-xs sm:text-sm font-bold text-white uppercase tracking-wider">Headline Variations</h3>
                  <div className="space-y-2">
                    {data.landing_page_copy?.headlines?.map((h: string, index: number) => (
                      <div key={index} className="rounded-lg border border-slate-900 bg-slate-950/20 p-2.5 sm:p-3 text-[10px] sm:text-xs text-white leading-normal font-semibold">
                        {h}
                      </div>
                    ))}
                  </div>
                ...
                <div className="space-y-3 sm:space-y-4">
                  <h3 className="text-xs sm:text-sm font-bold text-white uppercase tracking-wider">Core Copy Outline</h3>
                  <div className="rounded-xl border border-slate-900 bg-slate-950/20 p-3 sm:p-4 space-y-3 sm:space-y-4">
                    <div>
              ...
              <div className="pt-4 border-t border-slate-900/60">
                <h3 className="text-xs sm:text-sm font-bold text-white uppercase tracking-wider mb-3">Product Benefit Statements</h3>
                <div className="grid grid-cols-1 gap-2.5 sm:gap-3 md:grid-cols-3">
                  {data.landing_page_copy?.benefits?.map((b: string, index: number) => (
                    <div key={index} className="rounded-xl border border-slate-900 bg-slate-950/15 p-3 sm:p-4 text-[10px] text-slate-400 leading-relaxed">
                      {b}
                    </div>
                  ))}
                </div>
